...
export async function POST(req: Request) {
    ...
    if(supplierIdx && outletIdx && guestExtID && cashier && username && amount && refCode) {
        ...
        <soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
            <soap:Body>
                <InsertGuestWithdrawals_Temp_Lobby xmlns="http://ws.instawin.ph/">
                ...
                </InsertGuestWithdrawals_Temp_Lobby>
            </soap:Body>
        </soap:Envelope>`;
        ...
        let config = {
            ...
            url: `${process.env.WEB_SERVICE_MAIN}?op=InsertGuestWithdrawals_Temp_Lobby`,
            headers: { 
                ...
                xml2js.parseString(response.data, async (err, result) => {
                    ...
                    if(err) {
                        ...
                        resolve({
                            ...
                            data: result["soap:Envelope"]["soap:Body"][0]["InsertGuestWithdrawals_Temp_LobbyResponse"][0]["InsertGuestWithdrawals_Temp_LobbyResult"][0]
                        })
                    }
                })
            })
